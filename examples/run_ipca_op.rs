...
use pythonic_experiments::ipca_operator::{IpcaOperator, IpcaOperatorParams};
...
async fn main() {
    ...
    let operator = IpcaOperator {
        ...
        .boxed()],
        vector_sources: vec![],
        params: IpcaOperatorParams { n_comp: 50 },
    }
    .boxed();
    ...
    let mut file = File::create("output_ipca.png").unwrap();
