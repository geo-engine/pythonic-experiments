...
use pythonic_experiments::kmeans_operator::KmeansOperator;
...
async fn main() {
    ...
    let colorizer = Colorizer::linear_gradient(
        vec![
            (0., RgbaColor::black()).try_into().unwrap(),
            (255., RgbaColor::white()).try_into().unwrap(),
        ],
    ...
    let mut file = File::create("output_kmeans.png").unwrap();
